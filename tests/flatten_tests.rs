//! Tests for `#[serde(flatten)]` intersection-type generation.
...
mod tests {
    ...
    fn test_flatten_json_schema_distributes_base_into_variants() {
        ...
        for branch in one_of {
            assert_eq!(branch["additionalProperties"], serde_json::Value::Bool(false));
